...
public class DisplayAddressActivity extends ActionBarActivity implements
    ...
    public void onStop() {
        ...
        mLocationClient.disconnect();
        	...
        	TextView tv = (TextView) this.findViewById(R.id.text_connection_status);
        	tv.setText("STOP:" + e.getMessage());
        }
        super.onStop();
    }
    /*
    ...
    public void getAddress(View v) {
        ...
        try {
	        if (servicesConnected()) {
	            ...
	            (new DisplayAddressActivity.GetAddressTask(this)).execute(currentLocation);
	        }
        }
        catch(Exception e) {
        	TextView tv = (TextView) this.findViewById(R.id.text_connection_status);
        ...
        protected String doInBackground(Location... params) {
            ...
            try {
                ...
                // Catch network or other I/O problems.
                	...
                	tv.setText(exception1.getMessage());
                ...
                // Catch incorrect latitude or longitude values
                    ...
                    tv.setText(exception2.getMessage());
                    //
                    return errorString;
                }
